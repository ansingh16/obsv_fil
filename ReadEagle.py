...
Data = Data[(12.0<=Data[:,2]*con) & (Data[:,2]*con<=12.05)]
...
plt.xlabel('x(Mpc)')
plt.ylabel('y(Mpc)')
plt.title('Slice Plot with 05 Mpc width')
np.savetxt('Data_slice05.dat',Data*con)

fig.savefig('Plot_0.05Mpc.png')
#fig.savefig('testing50.png')
