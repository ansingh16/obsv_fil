...
for file in os.listdir("."):
    if file.startswith("filament_"):
        ...
        if((length.value > 10.0) and (length.value < 800.0)) :
           print "FILAMENT_LENGTH",length
           
           A = Analysis.Analysis(file)
           cs = Analysis.Analysis.plotting(A,ax2)
        '''
        A = Analysis.Analysis(file)
        Analysis.Analysis.plotting(A,ax2)
